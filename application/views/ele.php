...
.cont {
  ...
  align-items: center;
  height: 100vh;
  background-image:url(<?php echo base_url();?>assets/literary/ele/d2.jpg);
...
.app__bgimg-image--1 {
  background: url(<?php echo base_url();?>assets/literary/ele/d2.jpg) center center no-repeat;
  background-size: cover;
}
.app__bgimg-image--2 {
  background: url(<?php echo base_url();?>assets/literary/ele/d2.jpg) center center no-repeat;
...
<div>
	...
	<div class="app">
		...
		<div class="app__img">
			<img onmousedown="return false" src="<?php echo base_url();?>assets/literary/ele/lan.PNG" alt="city" />
		</div>

		<div class="app__text app__text--1">
			<div class="app__text-line app__text-line--4"><br>Literary Council</div>
      ...
      <div class="app__text-line app__text-line--4">
        <ul>
          <li><a href="<?php echo base_url();?>welcome/wordzone"><font size="5" face="verdena">WORD ZONE</font></a></li>
          <li><a href="<?php echo base_url();?>welcome/auli"><font size="5" face="verdena">AS YOU LIKE IT</font></a></li>
          <li><a href="<?php echo base_url();?>welcome/jam"><font size="5" face="verdena">JAM</font></a></li>
          <li><a href="<?php echo base_url();?>welcome/letusdiscuss"><font size="5" face="verdena">LET US DISCUSS</font></a></li>
          <li><a href="<?php echo base_url();?>welcome/poetryslam"><font size="5" face="verdena">POETRY SLAM</font></a></li>
          <li><a href="<?php echo base_url();?>welcome/thepotboiler"><font size="5" face="verdena">THE POTBOILER</font></a></li>
