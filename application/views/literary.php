...
.cont {
  ...
  align-items: center;
  height: 100vh;
  background-image:url(<?php echo base_url();?>assets/literary/d2.jpg);
...
.app__bgimg-image--1 {
  background: url(<?php echo base_url();?>assets/literary/d2.jpg) center center no-repeat;
  background-size: cover;
}
.app__bgimg-image--2 {
  background: url(<?php echo base_url();?>assets/literary/d2.jpg) center center no-repeat;
...
<div>
	...
	<div class="app">
		...
		<div class="app__img">
			<img onmousedown="return false" src="<?php echo base_url();?>assets/literary/lan.PNG" alt="city" />
		</div>
      ...
      <div class="app__text-line app__text-line--4">
        <ul>
          <li><a href="<?php echo base_url()?>welcome/ele"><font size="5" face="verdena">English Literary Events</font></a></li>
          <li><a href="<?php echo base_url()?>welcome/hle"><font size="5" face="verdena">Hindi Literary Events</font></a></li>
