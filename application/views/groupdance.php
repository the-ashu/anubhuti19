...
.cont {
  ...
  align-items: center;
  height: 100vh;
  background-image:url(<?php echo base_url();?>assets/dance/grpdance/d2.jpg);
...
.app__bgimg-image--1 {
  background: url(<?php echo base_url();?>assets/dance/grpdance/d2.jpg) center center no-repeat;
  background-size: cover;
}
.app__bgimg-image--2 {
  background: url(<?php echo base_url();?>assets/dance/grpdance/d2.jpg) center center no-repeat;
...
<div>
	...
	<div class="app">
		...
		<div class="app__img">
			<img onmousedown="return false" src="<?php echo base_url();?>assets/dance/grpdance/lan.PNG" alt="city" />
		</div>

		<div class="app__text app__text--1">
			<div class="app__text-line app__text-line--4"><br>Gruppe Tanzen</div>
			<div class="app__text-line app__text-line--3"> Group Dance</div>
      ...
      <div class="app__text-line app__text-line--4">
        <div class="rules">
          <h1><font size="5"><b>GRUPPE TANZEN</b></font></h1>

<p1><font size="3">EXPRESS  YOUR MOVES  SHOW ME YOUR STAMINA , IT IS A GROUP DANCE .</font></p1>

<h2><font size="4">RULES:</font></h2>
<p2><font size="3"> <ul>
  <li>Team  Size: Minimum 7 and maximum20.</li>
 <li>Dance Style: No boundation (All Dance Forms).</li>
 <li>During dance minimum 5 members are    compulsory at the stage.</li>
 <li>Judging Criteria: Choreography, Theme  and Props, Energy , Synchronization, Expressions, , Uses of stage, Innovations, Costumes, and Overall  impact.</li></ul></font></p2>



<font size="3">PRELIMS  :

<ul><li>	Team have to perform any sequence of their choice which will be part of  Final round performance and your sequence totally depends  upon dance .
<li>	Time limit : 4-5 min.</ul></font>


<h3>FINALS :</h3>
<p3><font size="3"><ul>
  <li>Team should perform extended version of prelims performance.<li>
  <li>Time limit: 8-12 min.</li>
</ul>


*
<ul>	<li>Props are allowed and props are  brought by the teams themselves. (Any kind of props which can  tampering/damaging the stage is strictly prohibited).</li>
	<li>In final round, teams can show there theme and use of props.</li>
	<li>Teams have to submit their tracks in mp3 format only  atleast  12 hours before their performance.</li>
	<li>Prop list should be submit with your track.</li>
	<li>The decision of the judges shall be final and binding.</li>
	<li>Event head is god and he can do anything.</li></ul></font></p3>
</div>
      </div>
	</div>
	<div class="pages">
