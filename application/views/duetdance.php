...
.cont {
  ...
  align-items: center;
  height: 100vh;
  background-image:url(<?php echo base_url();?>assets/dance/duetdance/d2.jpg);
...
.app__bgimg-image--1 {
  background: url(<?php echo base_url();?>assets/dance/duetdance/d2.jpg) center center no-repeat;
  background-size: cover;
}
.app__bgimg-image--2 {
  background: url(<?php echo base_url();?>assets/dance/duetdance/d2.jpg) center center no-repeat;
...
<div>
	...
	<div class="app">
		...
		<div class="app__img">
			<img onmousedown="return false" src="<?php echo base_url();?>assets/dance/duetdance/lan.PNG" alt="city" />
		</div>

		<div class="app__text app__text--1">
			<div class="app__text-line app__text-line--4"><br>Two For Tango</div>
			<div class="app__text-line app__text-line--3"> Duet Dance</div>
			<div class="app__text-line app__text-line--2"> </div>

		</div>

		<div class="app__text app__text--2">
			<div class="app__text-line app__text-line--4">Rules </div>
      ...
      <div class="app__text-line app__text-line--4">
        <div class="rules">
      <img src="<?php echo base_url();?>assets/dance/duetdance/duetrules.JPG"></img>
</div>
      </div>
	</div>
	<div class="pages">
