...
.cont {
  ...
  align-items: center;
  height: 100vh;
  background-image:url(<?php echo base_url();?>assets/drama/d2.jpg);
...
.app__bgimg-image--1 {
  background: url(<?php echo base_url();?>assets/drama/d2.jpg) center center no-repeat;
  background-size: cover;
}
.app__bgimg-image--2 {
  background: url(<?php echo base_url();?>assets/drama/d2.jpg) center center no-repeat;
...
<div>
	...
	<div class="app">
		...
		<div class="app__img">
			<img onmousedown="return false" src="<?php echo base_url();?>assets/drama/lan.PNG" alt="city" />
		</div>

		<div class="app__text app__text--1">
			<div class="app__text-line app__text-line--4"><br>Cultural Council</div>
			<div class="app__text-line app__text-line--3">DRAMA</div>
      ...
      <div class="app__text-line app__text-line--4">
        <ul>
          <li><a href="<?php echo base_url();?>welcome/nukkadnatak"><font size="5" face="verdena">Nukkad_nataK</font></a></li>
          <li><a href="<?php echo base_url();?>welcome/standupcomedy"><font size="5" face="verdena">StandUp_Comedy</font></a></li>
          <li><a href="<?php echo base_url();?>welcome/stageplay"><font size="5" face="verdena">Stage_Play </font></a></li>
