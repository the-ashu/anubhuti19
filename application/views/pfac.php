...
.cont {
  ...
  align-items: center;
  height: 100vh;
  background-image:url(<?php echo base_url();?>assets/pfac/d2.jpg);
...
.app__bgimg-image--1 {
  background: url(<?php echo base_url();?>assets/pfac/d2.jpg) center center no-repeat;
  background-size: cover;
}
.app__bgimg-image--2 {
  background: url(<?php echo base_url();?>assets/pfac/d2.jpg) center center no-repeat;
...
<div>
	...
	<div class="app">
		...
		<div class="app__img">
			<img onmousedown="return false" src="<?php echo base_url();?>assets/pfac/lan.PNG" alt="city" />
		</div>

		<div class="app__text app__text--1">
			<div class="app__text-line app__text-line--4"><br>PFAC</div>
      ...
      <div class="app__text-line app__text-line--4">
        <ul>
        <font size="4">  <li><a href="<?php echo base_url();?>welcome/photography"><font size="5" face="verdena">Photographic Events</font></a></li>
          <ul>
          <font size="4">  <li>Frame The Fest</li>
            <li>Picturesque</li>
            <li>Pixel Hunt</li>
            <li>Photo Story</li>
            <li>Through The Lenses</li>
          </ul>
</font>

        <font size="4">  <li><a href="<?php echo base_url();?>welcome/videography"><font size="5" face="verdena">Vediographic Events</font></a></li>
          <ul>
            <li>What if Ads were real</li>
            <li>Short Film</li></font>
