...
<head>
  <meta charset="UTF-8">
  <title>Anubhuti19 Coming Soon </title>
  
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/normalize/5.0.0/normalize.min.css">

  <link rel='stylesheet' href='<?php echo base_url();?>assets/coming/css/yxqdlj.css'>
...
<body>
  ...
  <div class="coming_content">
    ...
    <h3>Your patience is highly appreciated.</h3>
  </div>
</section>
  
  

    <script  src="<?php echo base_url();?>assets/coming/js/index.js"></script>
